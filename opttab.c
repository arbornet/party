...
struct optent opt[] = {
    ...
    {"alias", PF_STR | PF_SHOW, 1, NULL}, {"arg", PF_NO, 1, NULL},
    {"bs", PF_NO | PF_SEE | PF_SHOW, 1, NULL},
    {"back", PF_NUM | PF_STR, 1, DFLT_BACK},
    {"cols", PF_NUM | PF_STR | PF_SHOW, 1, DFLT_COLS},
    {"colon", PF_NO, 1, NULL}, {"control", PF_NO | PF_SEE | PF_SHOW, 1, NULL},
    {"debug", PF_NO | PF_STR, 0, DFLT_DEBUG}, {"env", PF_NO, 1, NULL},
    ...
    {"help", PF_NO | PF_STR, 1, DFLT_HELP}, {"intro", PF_STR, 1, DFLT_INTRO},
#ifndef NOCLOSE
    {"knockwait", PF_NUM | PF_STR, 1, DFLT_KNOCKWAIT},
#endif
    {"maildir", PF_STR | PF_SHOW, 1, DFLT_MAILDIR},
    {"prompt", PF_STR, 1, DFLT_PROMPT}, {"raw", PF_NO, 0, NULL},
    ...
    {"start", PF_STR, 1, DFLT_START}, {"tpmorp", PF_STR, 1, DFLT_TPMORP},
...
struct cmdent cmd[] = {{"back", 1}, {"chantab", 1},
#ifndef NOCLOSE
    {"close", 2},
#endif
    {"help", 1},
    ...
    {"open", 1},
#endif
    {"print", 1}, {"pwho", 2}, {"quit", 1}, {"read", 1}, {"save", 2},
    {"set", 1}, {"shell", 2}, {"version", 1}, {"who", 1},
